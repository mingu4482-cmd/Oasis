...
import { CloudRain, MapPin, Hash, TrendingUp, Brackets } from 'lucide-react';
...
export default function TemplateEditor({
  manholeId, location, waterLevel, riseRate, weatherStatus, rainfall, body,
  onManholeId, onLocation, onWaterLevel, onRiseRate, onWeatherStatus, onRainfall, onBody,
}: Props) {
  ...
  return (
    <div className={styles.editor}>
      <p className={styles.sectionLabel}>알림 템플릿 편집</p>
      ...
      <div className={styles.apiBox}>
        <p className={styles.groupTitle}>외부 API 연동</p>
        <div className={styles.hint}>
          KakaoMap 키는 REACT_APP_KAKAO_MAP_KEY, 기상청 키는 KMA_APIHUB_AUTH_KEY 환경변수로 사용합니다.
        </div>
      </div>
